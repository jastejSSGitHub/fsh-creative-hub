...
export function ProjectsPageClient({
  ...
  function renderGrid(projectList: ProjectCardData[], emptyMessage: string) {
    if (projectList.length === 0) {
      return (
        <div className="rounded-2xl border border-dashed border-hub-foreground/15 bg-hub-surface/60 px-6 py-12 text-center">
          <p className="text-sm text-hub-foreground/55">{emptyMessage}</p>
        </div>
      );
    }
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-1">
          <button
            ...
            className={cn(
              ...
              view === "all"
                ...
                : "text-hub-foreground/50 hover:text-hub-foreground",
            )}
          >
            All projects
          </button>
          ...
          >
            ...
            {trashedProjects.length > 0 && (
              <span className="ml-1.5 font-mono text-[0.65rem] text-hub-foreground/45">
        ...
        {view === "all" && activeProjects.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-hub-foreground/15 bg-hub-surface/60 px-6 py-12 text-center sm:py-16">
            <p className="font-display text-2xl font-extrabold text-hub-foreground">
              Drop your first project here
            </p>
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-hub-foreground/55">
            ...
            <button
              ...
              className={cn(
                ...
                "mt-6 min-h-11 rounded-xl bg-hub-final text-hub-foreground hover:bg-hub-final/90",
              )}
            >
